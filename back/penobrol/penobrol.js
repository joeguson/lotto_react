                            ...
                            if(err){console.log(err);}
                                ...
                                conn.conn.query(sql7, id, function(err, ccomments, fields){
                                    if(req.session.u_id){
                                            ...
                                            if(err){console.log(err);}
                                                ...
                                                conn.conn.query(sql8, [req.session.u_id, id], function(err, clikeStatus, fields){
                                                    if(err){console.log(err);}
                                                        ...
                                                        res.render('./jp/p-view', {topic:content[0], statusCheck:statusCheck, comments:comments, u_id:req.session.u_id, hashtag:hashtag, ccomments:ccomments, clikeStatus:clikeStatus});
                                                    }
                                                });
                                        ...
                                        res.render('./jp/p-view', {topic:content[0], comments:comments, hashtag:hashtag, ccomments:ccomments});
                                    }
                                });
                            }
                        }
