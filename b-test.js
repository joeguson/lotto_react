...
/************added to b-test form here************/


//A js file was created, name youtublog
var youtublog = require('./youtublog');
//3 jade files were created. name u, u-view, u-add;

    /************FOR YOUTUBLOG************/

app.get(['/youtublog'], youtublog.getYoutublog);
//app.get('/youtublog/add', youtublog.getAddPenobrol);
//app.post('/youtublog/add', youtublog.postAddPenobrol);
//app.post('/youtublog/:youtublog_no', youtublog.postAddComment);
//app.get(['/youtublog/:youtublog_no'], youtublog.getViewPenobrol);
//app.post('/youtubloglike/:id', youtublog.likesPenobrol);
//app.post('/pCommentlikes/:id', youtublog.likesComment); 
//app.post('/penobrol/:penobrol_no/:comment_no', youtublog.postAddCcomment);
//app.post('/pwarning/', youtublog.warningPenobrol);
//app.get(['/pedit/:penobrol_no'], youtublog.getEditPenobrol);
//app.post(['/pedit/:penobrol_no'], youtublog.postEditPenobrol);
//app.get(['/pcedit/:penobrol_no/:pcomment_no'], youtublog.getEditPcomment);
//app.post(['/pcedit/:penobrol_no/:pcomment_no'], youtublog.postEditPcomment);


/************added to b-test untill here************/


var todayCount = 1;

app.get('/test', testing.testing1);
app.post('/test', upload.single('userfile'), testing.testing2);
...
app.get('/cari/search', function(req, res){
    ...
    var hashtagsql = 'select * from hashtag AS result WHERE MATCH(hash) AGAINST(?)';
    var phtsql = '';
    var thtsql = '';
